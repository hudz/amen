...
function micoxUpload(form, url_action, id_element, html_show_loading, html_error_http, id, success){
	 ...
	 if(form==null || typeof(form)=="undefined"){ 
		 erro += "Element Form does not exist.\n";
	 ...
	 form.submit();
	 //override
	 //id = imageId from createSoalanContent.form.jsp in function javascript uploadImage()
	 //setImageId(id);
	 //while loading
	 if(html_show_loading.length > 0){
		// $m(id_element).innerHTML = html_show_loading;
		 setTimeout(function(){(success == "" || success == undefined)?"":success();}, 1000);
	 }
